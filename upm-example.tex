...
%\title{5G ISAC \& Semantic Enconding}
...
\begin{frame}{\secname}
    ...
    $800\times4\times 16$ (grid,technique,compression)
    %@800 grids × 4 compression techniques (JPEG, sJPEG, Tucker, sTucker) × N compression levels.
